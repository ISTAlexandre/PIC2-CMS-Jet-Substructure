#mpiexec -n 2 python3 python/run_data.py
import subprocess
import sys
import os
...
def main():
    ...
    for fname in my_files:
        ...
        subprocess.run([sys.executable, "python/clear_root_data.py", in_path], check=True)
        ...
        subprocess.run(["./build/lund_data", in_path, str(rank)], check=True)
