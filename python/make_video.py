'''
python3 python/make_video.py
'''
import os
import re
import subprocess

BASE = ["iterative_psi12", "iterative_lund","iterative_z","iterative_kt","iterative_delta","iterative_psi12_z"]
duration_s = 10
...
for dr in BASE:
    for name in sorted(os.listdir(dr)):
        ...
        out_mp4 = os.path.join(dr, f"{name}.mp4")
